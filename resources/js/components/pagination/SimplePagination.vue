...
const queryString = (value: number) => {
    return (
        props.dataPagination.links.find(
...
<template>
    <Pagination
        v-slot="{ page }"
        :items-per-page="dataPagination.per_page"
        :total="dataPagination.total"
        :sibling-count="1"
        show-edges
        :default-page="dataPagination.current_page"
    >
        <PaginationContent v-slot="{ items }" class="flex items-center gap-1">
            <a
                :href="
                    dataPagination.current_page !== 1
                        ? dataPagination.first_page_url
                        : undefined
                "
                ><PaginationFirst
            /></a>
            ...
            <a
                :href="
                    dataPagination.last_page !== dataPagination.current_page
                        ? dataPagination.last_page_url
                        : undefined
                "
                ><PaginationLast
            /></a>
